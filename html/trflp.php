      ...
      <td align='left' valign='baseline'>
        <font face='Arial, Helvetica, sans-serif'> forward match: &plusmn; &nbsp;
          <select name='forward_shift'><?php echo GetNumericList( $lower, $upper ); ?>
            </select>&nbsp; bps; reverse match: &plusmn; &nbsp;
          <select name='reverse_shift'><?php echo GetNumericList( $lower, $upper ); ?>
            </select>&nbsp; bps.
        </font></td>
    </tr>
<?php
...
<form name='trflp' enctype='multipart/form-data' method='post' action='runtrflp.php'>
...
DrawUpload( "Reverse Fragments:", "reverse_sample" );
...
// drwa the migraton shift discrepancies
DrawMatch( 1, 5 );

// draw the checkbox selections for sorting fields
DrawOption( "Sort By:", "sort_by",
    array( "Forward fragments", "Reverse fragments", "Abundance", "Name" ) );
